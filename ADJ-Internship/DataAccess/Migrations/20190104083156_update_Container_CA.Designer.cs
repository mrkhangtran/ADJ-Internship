...
namespace ADJ.DataAccess.Migrations
{
    ...
    [Migration("20190104083156_update_Container_CA")]
    partial class update_Container_CA
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ADJ.DataModel.ShipmentTrack.ArriveOfDespatch", b =>
                {
                    ...
                    b.HasOne("ADJ.DataModel.ShipmentTrack.Container", "Container")
                        .WithOne("ArriveOfDespatch")
                        .HasForeignKey("ADJ.DataModel.ShipmentTrack.ArriveOfDespatch", "ContainerId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("ADJ.DataModel.ShipmentTrack.CA", b =>
                {
                    b.HasOne("ADJ.DataModel.ShipmentTrack.Booking")
                        .WithMany("CAs")
                        .HasForeignKey("BookingId");

                    b.HasOne("ADJ.DataModel.ShipmentTrack.Container", "Container")
                        .WithOne("CA")
                        .HasForeignKey("ADJ.DataModel.ShipmentTrack.CA", "ContainerId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
